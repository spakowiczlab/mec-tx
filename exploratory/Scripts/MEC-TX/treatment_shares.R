...
#' \code{\link{prep_segs}}) and computes per-patient treatment duration
...
#'
#' @param segs_prepped A data frame produced by \code{\link{prep_segs}}.
...
#' \code{\link{prep_segs}} — specifically it must contain \code{t0} and
