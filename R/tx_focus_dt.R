...
#'   re-ordering). If \code{FALSE}, uses \code{has_subseq} for
...
#' \enumerate{
#'   \item Compute treatment type shares via \code{treatment_shares}.
...
#'   \code{\link{cox_forest_plot_from_df}}, \code{has_subseq}
#'
#' @import ggplot2
